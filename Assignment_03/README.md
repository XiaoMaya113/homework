...
- `data/colmap/sparse/1/cameras.bin`
- `data/colmap/sparse/1/images.bin`
- `data/colmap/sparse/1/points3D.bin`
- `data/colmap/dense/fused.ply`
- `outputs_full/dense_fused_preview.png`

mapper 可能生成多个 sparse model。本次 dense 使用注册图像最多的 `data/colmap/sparse/1`，其中包含 50 张注册图像。
...
| --- | ---: |
| Input images | 50 |
| COLMAP sparse model | `data/colmap/sparse/1` |
| Registered images | 50 |
| Sparse points | 1695 |
| Mean reprojection error | 0.6551 px |
| Dense output | `data/colmap/dense/fused.ply` |
| Dense fused points | 145934 |
